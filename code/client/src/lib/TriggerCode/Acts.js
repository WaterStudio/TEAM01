...
var PlayUIAnimation = ccs.BaseTriggerAction.extend({
    _tag: -1,
    _jsonName: "",
    _aniName: "",
    ctor: function () {
    ...
    init: function () {
        ...
        ccs.actionManager.playActionByName( this._jsonName, this._aniName);
    },
...
ccs.registerTriggerClass("PlayUIAnimation", PlayUIAnimation);